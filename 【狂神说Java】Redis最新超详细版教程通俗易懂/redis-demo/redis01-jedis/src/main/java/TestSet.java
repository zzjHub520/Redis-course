...
public class TestSet {
    public static void main(String[] args) {
        ...
        System.out.println("eleSet1和eleSet2的集：" + jedis.sinter("eleSet1", "eleSet2"));
        System.out.println("eleSet1和eleSet2的集：" + jedis.sunion("eleSet1", "eleSet2"));
        System.out.println("eleSet1和eleSet2的集：" + jedis.sdiff("eleSet1", "eleSet2"));
